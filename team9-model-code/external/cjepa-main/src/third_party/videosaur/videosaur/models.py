...
from src.third_party.videosaur.videosaur import configuration, losses, modules, optimizers, utils, visualizations
from src.third_party.videosaur.videosaur.data.transforms import Denormalize
...
class ObjectCentricModel(pl.LightningModule):
    ...
    def load_weights_from_checkpoint(
        ...
        # Load to CPU first so checkpoints saved from CUDA environments remain
        # readable on machines with older or mismatched GPU drivers.
