...
class PhyreSlotDataset(torch.utils.data.Dataset):
    """
...
def get_data(cfg, is_ddp, world_size, rank):
    ...
    train_dataset = PhyreSlotDataset(
        data=data["train"],
        split="train",
...
# Main Entry Point
# ============================================================================
@hydra.main(version_base=None, config_path="../../configs", config_name="config_train_causal_phyre_slot")
def run(cfg):
